...
load_dotenv() # to access the API KET From .env file
import google.generativeai as genai # to access the model

from PIL import Image # pillow is used to load, save, covert the format and manipulate the image
